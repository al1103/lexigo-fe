...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/ic_bright.svg
  SvgGenImage get icBright => const SvgGenImage('assets/icons/ic_bright.svg');

  /// File path: assets/icons/ic_cup.svg
  SvgGenImage get icCup => const SvgGenImage('assets/icons/ic_cup.svg');

  /// File path: assets/icons/ic_each.svg
  SvgGenImage get icEach => const SvgGenImage('assets/icons/ic_each.svg');

  /// File path: assets/icons/ic_learn.svg
  SvgGenImage get icLearn => const SvgGenImage('assets/icons/ic_learn.svg');

  /// File path: assets/icons/ic_money.png
  AssetGenImage get icMoney => const AssetGenImage('assets/icons/ic_money.png');
  ...
  /// File path: assets/icons/ic_practice.svg
  SvgGenImage get icPractice =>
      const SvgGenImage('assets/icons/ic_practice.svg');
  ...
  /// File path: assets/icons/ic_stories.svg
  SvgGenImage get icStories => const SvgGenImage('assets/icons/ic_stories.svg');

  /// File path: assets/icons/ic_translate.svg
  SvgGenImage get icTranslate =>
      const SvgGenImage('assets/icons/ic_translate.svg');
